...
import com.abhi.food_app.model.OrderHistoryRestaurant
    ...
    override fun onBindViewHolder(holder: ViewHolderOrderHistoryRestaurant, position: Int) {
        ...
        if (ConnectionManager().checkConnectivity(context)) {
            ...
            try {
                ...
                val sharedPreferencess=context.getSharedPreferences(context.getString(R.string.register_preference_file),Context.MODE_PRIVATE)
