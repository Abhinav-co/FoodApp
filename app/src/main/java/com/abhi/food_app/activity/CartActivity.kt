...
import com.abhi.food_app.adapter.CartAdapter
import com.abhi.food_app.model.CartItems
...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonPlaceOrder.setOnClickListener(View.OnClickListener {
                ...
                val sharedPreferencess=this.getSharedPreferences(getString(R.string.register_preference_file), Context.MODE_PRIVATE)
    ...
    fun createNotification(){
        ...
        val channelId="personal_notification"
            ...
            notificationBulider.setSmallIcon(R.drawable.ic_logo)
